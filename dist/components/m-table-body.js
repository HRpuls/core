...
var _TableBody2 = _interopRequireDefault(
  require('@material-ui/core/TableBody')
);
...
var _TableCell2 = _interopRequireDefault(
  require('@material-ui/core/TableCell')
);
  ...
  (0, _createClass2['default'])(MTableBody, [
      ...
      value: function renderUngroupedRows(renderData) {
        ...
        return renderData.map(function (data, index) {
          if (data.tableData.editing || _this.props.bulkEditOpen) {
            ...
            var path = _this.props.isTreeData
              ? [data.tableData.uuid]
              : [index + _this.props.pageSize * _this.props.currentPage];
            return /*#__PURE__*/ _react['default'].createElement(
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (
          this.props.options.paging &&
          this.props.pageSize > renderData.length
        ) {
