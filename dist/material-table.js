  ...
  (0, _createClass2['default'])(MaterialTable, [
    ...
    },
    {
      ...
      value: function setDataManagerFields(props, isInit, prevColumns) {
        ...
        var shouldReorder =
          isInit ||
          (!this.isRemoteData() && // Only if a defaultSortingDirection is passed, it will evaluate for changes
            defaultSortDirection && // Default sorting has changed
            (defaultSortColumnIndex !== prevSortColumnIndex ||
              defaultSortDirection !== prevSortDirection) && // Default sorting differs from current sorting
            ...
            calculatedProps.actions.push({
              ...
              onClick: function onClick() {
                ...
                if (_this3.state.showAddRow) {
                  _this3.props.editable.onRowAddCancelled &&
                    _this3.props.editable.onRowAddCancelled();
                }
